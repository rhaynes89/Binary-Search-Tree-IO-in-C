...
Assignment: Final Term Assignment 2
NID: ri303743....ID: 4543536
*/
...
int main(void)
{
	...
	// search from i = 0 i < numOfSearchWords
	...
	// delete names from i = 0 to i < numOfDeleteWords
...
Searching Phase:
jane: Found, Items before: 4
jones: Not found, Items before: 0
judy: Found, Items before: 6
Delete Phase:
alice: deleted
mary: deleted
judy: deleted
fred: deleted
Pre Order: tom bill jane dave joe
In Order: bill dave jane joe tom
Post Order: dave joe jane bill tom
*/
